    ...
    private static long createDummyWindow() {
        WindowProc defaultWndProc = new WindowProc() {
            ...
            public String getSignature() {
                return super.getSignature(); //To change body of generated methods, choose Tools | Templates.
            }

            @Override
            public long callback(long args) {
                return super.callback(args); //To change body of generated methods, choose Tools | Templates.
            }
        };
